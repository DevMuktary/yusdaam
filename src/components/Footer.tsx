          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-12 lg:w-1/3 w-full">
            ...
            <div className="flex flex-col items-center sm:items-start">
              ...
              <div className="flex flex-col gap-3 text-xs sm:text-sm font-semibold text-slate-light items-center sm:items-start">
                ...
                <Link href="/owner/register" className="hover:text-signal-red transition">Register as Owner</Link>
                <Link href="/rider/register" className="hover:text-signal-red transition">Join as Driver</Link>
              </div>
            </div>
