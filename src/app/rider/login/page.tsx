      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-8 lg:p-16">
        <div className="max-w-md w-full">
          ...
          <div className="mb-8 sm:mb-12 text-center lg:text-left">
            <h1 className="text-3xl sm:text-4xl font-black uppercase mb-2 tracking-wide text-signal-red">RIDER/DRIVER LOGIN</h1>
            <p className="text-sm sm:text-base text-slate-light">Enter your credentials to access your operations dashboard.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              <div className="flex justify-between items-end mb-1.5 sm:mb-2">
                ...
                <Link href="/rider/forgot-password" className="text-[10px] sm:text-xs font-bold text-cobalt hover:text-signal-red transition-colors uppercase tracking-wider">
                  Forgot?
                </Link>
              </div>
              <div className="relative">
          ...
          <div className="mt-8 text-center border-t border-cobalt/20 pt-8">
            <p className="text-xs text-slate-light">
              Not yet registered for asset allocation? <br className="sm:hidden" />
              <Link href="/rider/register" className="text-cobalt font-bold hover:text-signal-red transition-colors ml-1 uppercase tracking-wider">
                Apply Here
              </Link>
            </p>
          </div>
